...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_CLOCK_HFCLK_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_CLOCK_LFCLK_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_CLOCK_HFCLK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_CLOCK_LFCLK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PROMICRO_NRF52840_NRF52840_UF2, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARCH_HAS_BIT_REV, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARCH_HAS_IRQ_PENDING_OPS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARCH_HAS_DIRECT_INTERRUPTS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_NRF_COMMON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_NRF_HFCLK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_NRF_LFCLK, 1);
