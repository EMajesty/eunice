...
MEMORY
    {
    FLASH (rx) : ORIGIN = ((155648)), LENGTH = ((811008) - 0x0)
...
usbd_class_hs_area : ALIGN_WITH_INPUT { _usbd_class_hs_list_start = .; KEEP(*(SORT_BY_NAME(._usbd_class_hs.static.*))); _usbd_class_hs_list_end = .;; } > RAM AT > FLASH
    __data_region_end = .;
clock_control_nrf_irq_handler_area : { _clock_control_nrf_irq_handler_list_start = .; KEEP(*(SORT_BY_NAME(._clock_control_nrf_irq_handler.static.*))); _clock_control_nrf_irq_handler_list_end = .;; } > FLASH
